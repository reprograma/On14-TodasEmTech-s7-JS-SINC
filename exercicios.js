...
async function calcularValorEmReal(precoEmDolar) {
  try {
    ...
    //multiplicar o preço em real pelo dolar
    //console.log(precoEmReal);
    let precoFinal = precoEmReal + (precoEmReal * juros.juros1) + (precoEmReal * juros.juros2)
    
    console.log(`O preço final do produto é: ${precoFinal.toFixed(2).replace(".",",")}`);
...
//colocar o parametro que ela vai receber
