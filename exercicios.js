...
const resolver = async (produto, parcelasDesejadas) =>{
  try{
    ...
    console.log(`Seu notebook custa R4 ${valorTotal.replace('.', ',')} e você pagará em ${parcelasDesejadas}x de R$${valorFinalDaParcela.replace('.', ',')}`)
  }
  catch(err){
...
async function calcularValorEmReal(precoEmDolar) {
  try {
    ...
    //console.log("Dolar comercial:  ", dolar.comercial)
